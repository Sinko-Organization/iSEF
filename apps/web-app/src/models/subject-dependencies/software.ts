...
export const seDeptOld: DependencyListV2 = [
  ...
  // SECOND YEAR - FIRST SEM - REGULAR - OC
  {
    subjects: [
      ...
      {
        subjectCode: "EMath 2102",
        name: "Discete Mathematics II for SE",
        units: 3,
        prerequisites: ["EMath 1102", "EMath 1202"],
        coRequisites: [],
        type: "regular",
...

  {
    subjects: [
      ...
      {
        subjectCode: "PE 4a (W)",
        name: "Team Sports (Basketball/Volleyball)",
        units: 2,
        prerequisites: [],
        coRequisites: [],
        type: "regular",
  ...
  // THIRD YEAR - FIRST SEM - REGULAR - OC
  {
    subjects: [
      ...
      {
        subjectCode: "SE 3123",
        name: "Software Development Laboratory I",
        units: 3,
...

  {
    subjects: [
      ...
      {
        subjectCode: "Engg 1030",
        name: "Occupaional Safety and Health for Engineers",
        units: 3,
        prerequisites: [],
        coRequisites: [],
        yearStanding: 3,
      ...
      {
        subjectCode: "Engg 1034",
        name: "Ethics for Professional Managers and Engineers",
        units: 3,
        prerequisites: [],
        coRequisites: ["Engg 1030"],
        type: "regular",
      ...
      {
        subjectCode: "SE 3223",
        name: "Software Development Laboratory II",
        units: 3,
  ...
  // THIRD YEAR - SUMMER - REGULAR - OC
  {
    subjects: [
      {
        subjectCode: "Fil 12",
        name: "Sayko-Sosyolinggwistik na Pag-aaral ng Wikang Filipino",
        units: 3,
        prerequisites: [],
        coRequisites: [],
        type: "regular",
      ...
      {
        subjectCode: "Fil 13",
        name: "Pagsusuri at Pagpapahalaga sa mga Kontemporaryong Panitikan",
        units: 3,
        prerequisites: [],
        coRequisites: [],
        type: "regular",
